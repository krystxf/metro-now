...
export const isLeoStopId = (id: string): boolean =>
    id.startsWith(LEO_STOP_PREFIX);

export const isLeoPlatformId = (id: string): boolean =>
    id.startsWith(LEO_PLATFORM_PREFIX);

export const isLeoRouteId = (id: string): boolean =>
    id.startsWith(LEO_ROUTE_PREFIX);

export const fromLeoStopId = (id: string): string =>
    id.slice(LEO_STOP_PREFIX.length);
