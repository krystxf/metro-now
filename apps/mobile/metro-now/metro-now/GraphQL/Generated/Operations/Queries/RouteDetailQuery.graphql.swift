...
extension MetroNowAPI {
    nonisolated struct RouteDetailQuery: GraphQLQuery {
        ...
        static let operationDocument: ApolloAPI.OperationDocument = .init(
            definition: .init(
                #"query RouteDetail($id: ID!) { route(id: $id) { __typename id name color isNight isSubstitute vehicleType feed directions { __typename id platforms { __typename id name latitude longitude isMetro code } } shapes { __typename id directionId tripCount geoJson } } }"#
            )
        )
        ...
        nonisolated struct Data: MetroNowAPI.SelectionSet {
            ...
            nonisolated struct Route: MetroNowAPI.SelectionSet {
                ...
                nonisolated struct Direction: MetroNowAPI.SelectionSet {
                    ...
                    static var __parentType: any ApolloAPI.ParentType {
                        MetroNowAPI.Objects.RouteDirection
                    }
                ...
                nonisolated struct Shape: MetroNowAPI.SelectionSet {
                    ...
                    static var __parentType: any ApolloAPI.ParentType {
                        MetroNowAPI.Objects.RouteShape
                    }
                    ...
                    var directionId: MetroNowAPI.ID {
                        __data["directionId"]
                    }
