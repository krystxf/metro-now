...
extension MetroNowAPI {
  nonisolated struct DeparturesQuery: GraphQLQuery {
    ...
    public var stopIds: GraphQLNullable<[ID]>
    public var platformIds: GraphQLNullable<[ID]>
    public var limit: GraphQLNullable<Int32>
    public var metroOnly: GraphQLNullable<Bool>
    public var minutesBefore: GraphQLNullable<Int32>
    public var minutesAfter: GraphQLNullable<Int32>
    ...
    nonisolated struct Data: MetroNowAPI.SelectionSet {
      ...
      var departures: [Departure] { __data["departures"] }
      ...
      nonisolated struct Departure: MetroNowAPI.SelectionSet {
        ...
        static var __parentType: any ApolloAPI.ParentType { MetroNowAPI.Objects.Departure }
        static var __selections: [ApolloAPI.Selection] { [
        ...
        var headsign: String? { __data["headsign"] }
        var isRealtime: Bool { __data["isRealtime"] }
        var platformCode: String? { __data["platformCode"] }
        var departureTime: DepartureTime { __data["departureTime"] }
        ...
        nonisolated struct DepartureTime: MetroNowAPI.SelectionSet {
          ...
          static var __parentType: any ApolloAPI.ParentType { MetroNowAPI.Objects.DepartureTime }
          static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          var predicted: MetroNowAPI.ISODateTime { __data["predicted"] }
          var scheduled: MetroNowAPI.ISODateTime { __data["scheduled"] }
        }
