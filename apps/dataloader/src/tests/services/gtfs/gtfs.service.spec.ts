...
describe("buildGtfsShapeDatasets", () => {
    it("derives route geometries and primary shapes", () => {
        ...
        expect(datasets.gtfsRouteShapes).toEqual([
            {
                feedId: GtfsFeedId.PID,
                routeId: "L1",
                directionId: "0",
    ...
    it("rejects trip shapes missing from shapes.txt", () => {
        expect(() =>
            buildGtfsShapeDatasets({
                feedId: GtfsFeedId.PID,
                trips: [
        ...
        ).toThrow(/missing shape 'missing-shape'/);
    });
});

describe("buildGtfsStationEntranceDataset", () => {
    it("derives metro station entrances from GTFS stops", () => {
        ...
        expect(datasets.gtfsStationEntrances).toEqual([
            {
                id: "U1072E1",
                feedId: GtfsFeedId.PID,
                stopId: "U1072",
...
describe("GtfsService", () => {
    it("parses blank stop names for non-entrance GTFS locations", () => {
